...
<html lang="es">
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
         <title><fmt:message key="title.springbootstrapdialogwebapp"/></title>
        ...
        <link href="${cssPath}springbootstrapdialogwebapp.css" rel="stylesheet">
        ...
        <script type="text/javascript" src="${jsPath}springbootstrapdialogwebapp.js"></script>
    </head>
    <body>
        <div class="container">
