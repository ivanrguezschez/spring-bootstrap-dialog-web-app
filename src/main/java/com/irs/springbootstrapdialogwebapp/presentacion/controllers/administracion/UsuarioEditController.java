package com.irs.springbootstrapdialogwebapp.presentacion.controllers.administracion;

import com.irs.springbootstrapdialogwebapp.negocio.servicios.RolService;
import com.irs.springbootstrapdialogwebapp.negocio.servicios.UsuarioService;
...
import com.irs.springbootstrapdialogwebapp.presentacion.ConstPresentacion;
import com.irs.springbootstrapdialogwebapp.presentacion.commands.administracion.UsuarioEditCommand;
import com.irs.springbootstrapdialogwebapp.presentacion.controllers.BaseController;
...
public class UsuarioEditController extends BaseController {
    ...
    private ModelMap buildUsuarioViewModel(final Integer idUsuario) throws ServiceException {
        ModelMap model = new ModelMap();
    ...
    public ModelAndView usuarioViewHandler(
        ...
        ModelMap model = buildUsuarioViewModel(idUsuario);

        return new ModelAndView(ConstPresentacion.VIEW_NAME_USUARIO_VIEW_KEY, model);
    }

    @RequestMapping(value = "/administracion/usuarioViewDialog.htm", method = RequestMethod.GET)
    public ModelAndView usuarioViewDialogHandler(
            @RequestParam(value = "idUsuario", required = true) Integer idUsuario,
            HttpServletRequest request) throws ServiceException {
        ModelMap model = buildUsuarioViewModel(idUsuario);
        
        return new ModelAndView(ConstPresentacion.VIEW_NAME_USUARIO_VIEW_DIALOG_CONTENT_KEY, model);
    }
